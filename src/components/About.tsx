    ...
    <div>
      ...
      <div className="max-w-4xl">
        <Paragraph className=" mt-4">
          Hey there, I&apos;m Karan Soni -  Dynamic SDET/QA expert with medium proficiency in
          Python, adept at designing and executing algorithmic
          test scenarios. Excellent problem-solving skills with a
          capacity for leveraging Generative AI and swiftly
          mastering new technologies. Strong collaboration
          and documentation abilities ensure high-quality
          software and efficient issue resolution.
        </Paragraph>
